...
class ProjectMessagesControllerTest < ActionController::TestCase
  ...
  test "should create project_message" do
    assert_difference('ProjectMessage.count') do
      post :create, project_message: { email_body: @project_message.email_body, fax_body: @project_message.fax_body, sms_body: @project_message.sms_body, title: @project_message.title }
    end
  ...
  test "should update project_message" do
    put :update, id: @project_message, project_message: { email_body: @project_message.email_body, fax_body: @project_message.fax_body, sms_body: @project_message.sms_body, title: @project_message.title }
    assert_redirected_to project_message_path(assigns(:project_message))
  end
